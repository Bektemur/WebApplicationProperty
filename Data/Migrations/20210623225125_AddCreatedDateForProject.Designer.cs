...
namespace WebApplicationProperty.Data.Migrations
{
    ...
    [Migration("20210623225125_AddCreatedDateForProject")]
    partial class AddCreatedDateForProject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplicationProperty.Data.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("WebApplicationProperty.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebApplicationProperty.Models.CallbackModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApplicationProperty.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApplicationProperty.Models.Province", b =>
                {
                    b.Property<int>("ProvinceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("WebApplicationProperty.Data.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApplicationProperty.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplicationProperty.Models.City", b =>
                {
                    b.HasOne("WebApplicationProperty.Models.Province", "Province")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("WebApplicationProperty.Models.Property", b =>
                {
                    b.HasOne("WebApplicationProperty.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("WebApplicationProperty.Models.City", "City")
                        .WithMany("Properties")
